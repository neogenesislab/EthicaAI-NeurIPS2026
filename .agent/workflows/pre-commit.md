...
import re
patterns = {'api_key': r'api_key', 'sk-': r'(?<![a-z])sk-[a-zA-Z0-9]{20}', 'token=': r'token=[^\s]{10}', 'password': r'password\s*=', 'ZENODO_TOKEN': r'ZENODO_TOKEN', 'email': r'@[A-Za-z0-9.-]+', 'phone': r'010-\d{4}'}
found = []
