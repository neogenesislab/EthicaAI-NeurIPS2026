...
load_dotenv(os.path.join("d:", os.sep, "00.test", "PAPER", "EthicaAI_anon2", ".env"))
token = os.getenv("ZENODO_ACCESS_TOKEN")
h = {"Authorization": "Bearer " + token}
pdf_path = os.path.join("d:", os.sep, "00.test", "PAPER", "EthicaAI_anon2", "NeurIPS2026_final_submission", "paper", "unified_paper.pdf")
...
metadata = {
    "metadata": {
        ...
        "description": (
            ...
            "</ul>"
            "<p>Code repository withheld for anonymous review.</p>"
        ),
        "creators": [
