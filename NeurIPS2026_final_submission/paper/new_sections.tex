...
Proposition~\ref{thm:impossibility} holds \emph{independently of $M/N$}.
...
\label{cor:bypass}
Under the conditions of Proposition~\ref{thm:impossibility},
...
This validates Proposition~\ref{thm:impossibility}'s prediction that the trap
...
LOLA & Opp.\ Shaping & $0.490 \pm 0.034$ & 51.0 & \\
...
the signal dilution (Proposition~\ref{thm:impossibility}(i)) by
