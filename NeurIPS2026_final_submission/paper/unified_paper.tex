...
Theorem~\ref{thm:critical} provides the engineering specification: in our model, $\phi_1^* \geq 1.64$ (truncated to 1.0), meaning \textbf{partial commitment is provably insufficient} when the recovery rate at the tipping point is small.
...
Anticipating opponent learning does not help when all opponents face the same structural barrier.
